    ...
    def download_image(self,image_url,image_format,main_directory,dir_name,count,print_urls,socket_timeout,prefix,print_size,no_numbering):
        ...
        try:
            ...
            try:
                ...
                #DOMINIQUE CODE MODIFICATION SECTION 2 STARTS:
                fileAppend1 = open("information.txt", "a+")
                fileAppend1.write(image_name+"\r")
                fileAppend1.close()
                
                #DOMINIQUE CODE MODIFICATION SECTION 2 ENDS
        ...
        while count < limit+1:
            ...
            if object == "no_links":
                ...
                if arguments['metadata']:
                    ...
                    #DOMINIQUE'S CODE MODIFICATION SECTION 1 START:
                    #print("\nImage Metadata: " + str(object))
                    MetaData = str(object)
                    fileAppend2 = open("information.txt", "a+")
                    fileAppend2.write(MetaData+";")
                    fileAppend2.close;
                    print("\nImage Metadata: " + MetaData)
                
                    #DOMINIQUE'S CODE MODIFICATION SECTION 2 END
