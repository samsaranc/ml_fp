...
def run_images_exp():
    print("Initializing k-DPP-based diversity function.");
    print("Computing SIFT features of image data ");
    print("------------------------------------------------------");
    # read image dataset
    (records,female,scientist)=read_images.read_dataset_sift()
    DATA_SIZE=len(records)
    NO_SAMPLES=100
    print("finished computing SIFT features of image data ");
    ...
    print("********************************************************");
    print("begin sampling images using different diversity functions ");

    sample_methods=['uniform','k-DPP','P-DPP']
    ...
    for method in sample_methods:
        for PERCENT_MALE in [10,20,30,40,50]:
            ...
            for sample_no in range(NO_SAMPLES):
                ...
                # sample according to a given sampling method
